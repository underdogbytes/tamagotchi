export const tamagotchiElement = {
  imagem: document.getElementById('tamagotchi'),
  mensagem: document.getElementById('tamagotchi_msg')
}
...
export const assets = {
  ...
  'sono_1': {
    imagem: 'src/img/creatures/shark-hammer/happy.png',
    mensagem: 'Não estou com sono, obrigado!'
  },
  'sono_2': {
